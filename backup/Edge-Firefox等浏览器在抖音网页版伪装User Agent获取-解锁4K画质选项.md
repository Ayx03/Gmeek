...
使用[User-Agent Switcher and Manager](https://chromewebstore.google.com/detail/user-agent-switcher-and-m/bhchdcejhohfmigjafbampogmaanbfkg)伪装支持4K的User Agent就会有4K，下面是我测试过能获得4K的UA，来自Brave 1.84.141 Chromium: 142.0.7444.176 (正式版本) （64 位）
